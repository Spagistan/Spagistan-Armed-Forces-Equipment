class XtdGearInfos {
    class CfgWeapons {
		...
		model = "Flora_RHS_AFRF";
		Division = "VMF/Subdued";
		};

		//Gorka-R
		class rhs_uniform_gorka_r_g {
		model = "GorkaR_RHS_AFRF";
		camo = "Green";
		Gloves = "No";
		};
		...
		//AK-103 1 Dunno what the difference is lol
		class rhs_weap_ak103_1 {
		model = "AK1031_RHS_AFRF";
		Mounts = "None";
		};
		...
		//AK-103 2 Dunno what the difference is lol
		class rhs_weap_ak103_2 {
		model = "AK1032_RHS_AFRF";
		Mounts = "None";
		};
		...
		//Altyn without Face Shield
		class rhs_altyn_novisor {
		model = "AltynNOFS_RHS_AFRF";
		Balaclava = "No";
		ESS = "No";
		};
		...
		//6M2 Helmet Slot
		//RHS please name your thingies better
		class rhs_6b47 {
		model = "6B47_RHS_AFRF";
		Variant = "STD";
		};
